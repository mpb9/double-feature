    ...
    <>
      ...
      <main>
        ...
        <p>
          ...
          misguided belief in the streaming service. I begrudgingly put my
          stubbornness aside and took one last glance at the movies that were
          supposedly "for me".
        </p>
        <p>
        ...
        <p>
          ...
          <i>Requiem For a Dream</i> and <b>that</b> fateful glance, Prime broke
          me. I know this because, when my eyes settled on{" "}
          <i>Requiem For a Dream</i>, I suddenly concluded that, not only had I
          seen it before, but this would be an ideal time for a rewatch. About
          30 minutes into the movie, I began to wonder why Jim Carrey hadn't
          shown up yet. About 10 seconds later, I realized that the movie I'd
          been watching for the previous half hour was not, in fact,{" "}
        ...
        <p>
          ...
          do still go hard as hell, so I guess credit to Aronofsky for at least
          having great taste in who to steal from{" "}
          <i>
        ...
        <div>
          <img
            src={`${IMG_ROUTES.articles}${articleSpecs.id}/requiem-vs-perfect-blue.jpg`}
        ...
        <p>
          <i>
            ...
            because <b>WOW</b> was that an emotionally intense experience that I
            wasn't prepared to endure this afternoon)
          </i>
        </p>
      </main>
    </>

    ...
    <>
      ...
      <main>
        ...
        <p>
          ...
          political messages were (anti-Israel + anti-ICE, to be specific). The
          bar is miles below the basement floor, but I still found it
        ...
        <p>
          ...
          releasing an overtly political, anti-billionaire genre movie depicting
          genocide in 2025 and the biggest movie of the year{" "}
          ...
          mega-franchises as signifiers of cultural shifts, but with how market
          researched their every decision is, it does indicate something about
          the general public shifting to a more humane approach to politics.
        </p>
        <p>
          ...
          movie. Had fun. Cautiously optimistic about what it means for populist
          politics going forward. Still couldn't care less about the future of
          this DCU 2.0 thing.
        </p>
      </main>
    </>

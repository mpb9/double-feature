    ...
    <>
      ...
      <main>
        ...
        <p>
          ...
          watched it, but its such a shame that <i>The Curse</i> exists
          exclusively on unpopular streaming services (paramount+/showtime). the
          series' unconventionality and harsh nature would've been off-putting
          for the vast majority of viewers regardless, but the intentionality of
          its brazenness/awkwardness is <i>so</i> rewarding and never played for
          shock value… just so much depth in general and such a collision of
          passionate, talented, and inquisitive people at the peak of their
          powers, including:
          <ul>
            <li>
          ...
          <p>
            ...
            streaming subscription to watch it, im so grateful that the project
            was funded and developed with so much creative freedom. everyone
            should watch this show for many reasons, but most importantly:
          </p>
        </p>
        <ul>

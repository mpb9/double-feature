  ...
  return (
    <>
      ...
      <main>
        ...
        <p>
          Like "
          <a href="https://boxd.it/C69e" rel="nofollow">
        ...
        <p>
          In "Rebel Ridge", Aaron Pierre plays a former marine named Terry who,
          as a result of his military experience, approaches tasks with the
        ...
        <p>
          Tying it back into "How To Build a Pipeline" again (perhaps
          ...
          <br /> <br />I really liked this movie - just the sheer intensity and
          ...
          <a href="https://boxd.it/a75m" rel="nofollow">
            Green Room
          </a>
        ...
        <p>
          <i>
            (I've seen more movies besides this and "How To Blow Up a Pipeline"
            I promise)
          </i>
        </p>
      </main>

    ...
    <div id="article">
      <div className="flex flex-col items-center w-full min-h-screen m-auto bg-transparent">
        ...
        <main>
          ...
          <p>
            In <i>Rebel Ridge</i>, Aaron Pierre plays a former marine named
            Terry who, as a result of his military experience, approaches tasks
            with the acronym PACE (Primary Alternative Contingency Emergency) in
            mind. In rapid succession, the corruption of a police force and the
            complicity of the local judicial system negate Terry's primary,
            alternative, and contingency plans for delivering the bail money
            needed to save his cousin from confronting his former gang members
            in prison. The movie ironically uses US military defined logic as
            the protagonist's rationale when he revolts against the same system
            he once enlisted to protect. By their own definition his only option
            is to combat oppression by any means necessary. When it becomes
            evident that economic pressures have poisoned a justice system so
            deeply that it survives on injustice, then the system must be
            abolished.. and Terry fucks that shit up in the most satisfying
            humane way possible.
          </p>
          <p>
            Tying it back into <i>How To Build a Pipeline</i> again (perhaps
            unfairly).. they both outline one's duty to revolt against
            oppressive systems and proceed to make the defiance incredibly
            engaging and cinematic (setting aside my cynicism in regards to
            performative revolution to avoid another tangent). Basically,{" "}
            ...
            This movie does have a few character tropes that, while well
            executed, follow predictable arcs (both female leads). Aside from
            that I don't really see any need to nitpick when there's no need to,
            and I thought this was a dope ass movie so there!
          </p>
          <p>
            <i>

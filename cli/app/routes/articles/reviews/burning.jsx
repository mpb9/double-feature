    ...
    <>
      ...
      <main>
        ...
        <p>
          ...
          themselves in a liminal space (<i>Totoro</i> spends so much tagging
          along with the everyday whims of its protagonists, the{" "}
          ...
          the primary reason why everyone describes his films as dreamlike, but
          (finally got to the segway) the longer you confine someone in a
          liminal state, the easier it is for tension and dread and anxiety and
          solitude to creep into their day-dream. Miyazaki’s mastery lies in
          understanding precisely how long it will take for the uneasiness of
          silence to entrench itself in the subconscious, choosing only then to
          allow the audience back to the status quo. In <i>Burning</i>, director
          Lee Chang-dong, dares posit the question: what if I were to try and
          find out just how long it takes for liminal anxiety and dread to gain
          total control over my audience’s psyche?
        </p>
      </main>
    </>
  );

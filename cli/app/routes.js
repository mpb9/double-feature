...
export default [
  ...
  layout(`${DIR_ROUTES.layouts}review.jsx`, [
    // ! currently not using the review.jsx layout… will decide on whether or not to reincorporate in NEAR future
    // at the given moment, review.jsx inhibits customization on the <HEAD>.
    // this is due to the layout's meta() function which doesn't allow individual articles to alter the <HEAD> to their liking.
    ...prefix("review", []),
  ]),
